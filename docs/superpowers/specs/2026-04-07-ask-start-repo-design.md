...
| `backoffice` | 🖥️ Backoffice — admin dashboard | `frontend-backoffice-boilerplate` |
...
### Group 4 — Tech Context (all optional)

| Field | Type |
|---|---|
| API Endpoint URL | text input |
| Production URL | text input |
| Target device | radio: Desktop / Mobile / Both |
...
3. Config ค่าเริ่มต้นตาม tech context ที่ให้ไว้
```
